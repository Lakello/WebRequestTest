namespace Features.Weather.Runtime.Views
{
	...
	{
		[Header("Roots")]
		[SerializeField] private GameObject _weatherRoot;
		[SerializeField] private GameObject _loadingRoot;
		[SerializeField] private GameObject _updateRoot;
		...
		public void SetUpdating(bool isUpdating)
		{
			if (_updateRoot != null)
			{
				_updateRoot.SetActive(isUpdating);
			}
		}
